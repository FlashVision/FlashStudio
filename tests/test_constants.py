...
from flashstudio.constants import (
    IMG_EXTENSIONS, VIDEO_EXTENSIONS, WEIGHT_EXTENSIONS, CKPT_BEST, CKPT_LAST, CKPT_FINAL_INFERENCE, CKPT_FINAL_FP16,
    CKPT_BEST_INFERENCE, COMPLETE_MARKERS, BEST_WEIGHT_PRIORITY, PROJECT_ROOT, DEFAULT_SAVE_DIR, DEFAULT_DATA_DIR,
    ...
    INFER_NUM_CLASSES, EXPORT_IMG_SIZES, EXPORT_OPSET_MIN, EXPORT_OPSET_MAX, EXPORT_OPSET_DEFAULT,
